...
// What a GS1 parser hands over for a box of cured meat: two pieces, 2.497 kg.
...
describe("BarcodeStock", () => {
    ...
    test("a measure of the wrong kind never becomes the quantity", () => {
        // A length: it says nothing about how much of a product to pick.
    ...
    test("without a measure, whatever the barcode stated stands", () => {
        const state = stateWithUoms();
